    ...
    <div class="container">
      ...
      <div class="right-side">
        <div class="form-container">
          <form id="signupForm" action="../../../src/controller/Register.php" method ="post" autocomplete="off">
            <h1>Sign Up</h1>
            ...
            <div class="under-links">
              <span>Alreay have an account?  <a href="login.html" class="link">Login</a></span>
            </div>
          </form>
