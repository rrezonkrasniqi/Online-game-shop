          ...
          <ol class="carousel__viewport">
            <li id="carousel__slide1" tabindex="0" class="carousel__slide">
              <div class="carousel__snapper">
                <a class="carousel__prev" id="prev-button"
                  ><img src="images/next.svg" alt="" class="prev-button"
                /></a>
                <img
                  src="images/Game_Images/Formula_1.jpg"
                  alt=""
                  class="cover-images"
                  id="cover-image"
                />
                ...
                <a class="carousel__next" id="next-button"
                  ><img src="images/next.svg" alt="" class="next-button"
                /></a>
              </div>
            </li>
          </ol>
    ...
    <script src="js/GameCard.js"></script>
      ...
      <div class="backwrap gradient">
        <div class="back-shapes">
          ...
          <span
            class="floating cross"
            style="top: 49.54034729315628%; left: 53.75%; animation-delay: -2s"
          ></span>
          <span
            class="floating cross"
            style="
