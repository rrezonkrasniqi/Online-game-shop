        ...
        <div class="form-container">
          <form id="loginForm">
            ...
            <div id="password-container">
              ...
              <i id="eye" class="fa-sharp fa-solid fa-eye-slash" style="color: #000000; "></i>
            </div>

            <button type="button" onclick="saveAndRedirect()">Login</button>
            <div class="under-links">
              <span> <a href="signup.html" class="link">Sign Up</a></span>
            </div>
          </form>
        </div>
